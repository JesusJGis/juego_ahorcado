    ...
    try:
        ...
        for doc in documentos_db:
            if "respuesta" in doc and "pregunta" in doc:
                ...
                # Aviso útil para depurar tus datos
...
def dibujar_juego(pantalla):
    ...
    if sprite_img and estado_partida == "JUGANDO":
        sprite_pequeno = pygame.transform.scale(sprite_img, (150, 150))
        pantalla.blit(sprite_pequeno, (ANCHO_PANTALLA - 160, 180))
